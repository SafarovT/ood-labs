...
void DialogWithUser()
{
	...
	else if (beverageChoice == 2)
	{
		...
		if (teaChoice == 1)
		{
			beverage = make_unique<CTea>(TeaSort::Ahmad);
		}
		else if (teaChoice == 2)
		{
			beverage = make_unique<CTea>(TeaSort::Akbar);
		}
		else if (teaChoice == 3)
		{
			beverage = make_unique<CTea>(TeaSort::Anchan);
		}
		else if (teaChoice == 4)
		{
			beverage = make_unique<CTea>(TeaSort::Assam);
		}
		else
		{
			return;
	...
	else if (beverageChoice == 3)
	{
		...
		if (sizeChoice == 1)
		{
			beverage = make_unique<CMilkshake>(MilkshakeSize::Small);
		}
		else if (sizeChoice == 2)
		{
			beverage = make_unique<CMilkshake>(MilkshakeSize::Medium);
		}
		else if (sizeChoice == 3)
		{
			beverage = make_unique<CMilkshake>(MilkshakeSize::Large);
		}
		else
		{
			return;
...
int main()
{
	...
	// Подробнее рассмотрим работу MakeCondiment и оператора <<
	{
		...
		auto tea = make_unique<CTea>(TeaSort::Assam);
		...
		*/
		...
		auto oneMoreLemonIceTea =
			make_unique<CTea>(TeaSort::Ahmad)	// Берем чай
